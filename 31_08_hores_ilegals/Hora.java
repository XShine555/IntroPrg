...
public class Hora {
    ...
    public void setHores(int hora) throws IllegalArgumentException {
        if (hora < 0 || hora >= 24)
        {
            throw new java.lang.IllegalArgumentException("hores fora de rang: " + hora);
        }
        this.hores = hora;
    }
    ...
    public void setMinuts(int minuts) throws IllegalArgumentException {
        if (minuts < 0 || minuts >= 60)
            throw new java.lang.IllegalArgumentException("minuts fora de rang: " + minuts);
    ...
    public void setSegons(int segons) throws IllegalArgumentException {
        if (segons < 0 || segons >= 60)
            throw new java.lang.IllegalArgumentException("segons fora de rang: " + segons);
