...
public class MatriculaValida {
    ...
    public static boolean esLletraValidaPerMatriculaItaliana(char thisChar) {
        return Character.isLetter(thisChar) && Character.isUpperCase(thisChar) && thisChar != 'È' && thisChar != 'Ç' && thisChar != 'À' && thisChar != 'Ñ' && thisChar != 'ß' && thisChar != 'I' && thisChar != 'O' && thisChar != 'Q' && thisChar != 'U';
    }
}