...
public class Entorn {
    ...
    private static void cerca() {
        ...
        if (!preuStr.isBlank() && !preuStr.equals("!")) {
            ...
            Vi plantilla = new Vi(null, nom, -1, -1, null, null, null, null);
            Vi result = botiga.cerca(plantilla);
            if (result != null) {
                System.out.println(String.format("Trobat:%s", result.toString()));
            } else {
        ...
        if (!estocStr.isBlank() && !estocStr.equals("!")) {
            ...
            Vi plantilla = new Vi(null, nom, preu, -1, null, null, null, null);
            Vi result = botiga.cerca(plantilla);
            if (result != null) {
                System.out.println(String.format("Trobat:%s", result.toString()));
            } else {
        ...
        if (lloc.equals("!")) {
            Vi plantilla = new Vi(null, nom, preu, estoc, null, null, null, null);
            Vi result = botiga.cerca(plantilla);
            if (result != null) {
                System.out.println(String.format("Trobat:%s", result.toString()));
            } else {
        ...
        if (origen.equals("!")) {
            Vi plantilla = new Vi(null, nom, preu, estoc, lloc, null, null, null);
            Vi result = botiga.cerca(plantilla);
            if (result != null) {
                System.out.println(String.format("Trobat:%s", result.toString()));
            } else {
        ...
        if (tipus.equals("!")) {
            Vi plantilla = new Vi(null, nom, preu, estoc, lloc, origen, null, null);
            Vi result = botiga.cerca(plantilla);
            if (result != null) {
                System.out.println(String.format("Trobat:%s", result.toString()));
            } else {
        ...
        if (collita.equals("!")) {
            Vi plantilla = new Vi(null, nom, preu, estoc, lloc, origen, tipus, null);
            Vi result = botiga.cerca(plantilla);
            if (result != null) {
                System.out.println(String.format("Trobat:%s", result.toString()));
            } else {
