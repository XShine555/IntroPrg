 ...
 */
 ...
 public class Hora {
    ...
    public static int compareTo(Hora hora1, Hora hora2) {
        int comparacio = comparaValors(hora1.hores, hora2.hores);
        if (comparacio == 0) {
            comparacio = comparaValors(hora1.minuts, hora2.minuts);
            if (comparacio == 0) {
                comparacio = comparaValors(hora1.segons, hora2.segons);
            }
        }
        return comparacio;
    }
