...
ja que només té un atribut de tipus int (32 bits).

Baso els meus càlculs en el fet que cada variable de tipus int ocupa 32 bits, la qual cosa equival a 4 bytes.


Pregunta 3. Fins la línia 5
===========================

El nombre d'instàncies és 0, ja que fins a la línia 5 només es declara la variable renatI sense crear cap objecte.

Pregunta 4. Fins la línia 6
===========================

El nombre d'instànces de GatRenat fins a la línia 6 (inclosa) és 1.
...
Perquè cada instància de GatRenat s'inicialitza amb 7 vides i, en executar les línies 7 i 10, ambdues variables referencien objectes on l'atribut vides encara conserva el seu valor inicial 7.

Pregunta 7. Vides diferents a 13 i 14
=====================================

Les línies 13 i 14 mostren diferent nombre de vides pels gats Renat I i Renat II, perquè l'increment realitzat sobre l'atribut vides de la instància referenciada per renatI no afecta la instància associada a renatII.

Pregunta 8. El comentari de la línia 16
=======================================

El comentari de la línia 16 indica que, en assignar a renatII el valor de renatI, l'objecte original referenciat per renatII ja no té cap variable que l'apunti.

Pregunta 9. Vides iguals a 17 i 18
==================================

Les línies 17 i 18 mostren les mateixes vides pels gats Renat I i Renat
II, perquè renatII apunta a la mateixa instància que renatI.

Pregunta 10. Vides iguals a 21 i 22
===================================

Les línies 21 i 22 mostren les mateixes vides pels gats Renat I i Renat II
malgrat la instrucció de la línia 20, perquè renatII apunta a la mateixa instància que renatI.
...
La raó és que renatII apunta a la mateixa instància que renatI, de manera que només hi ha una instància de GatRenat en memòria.